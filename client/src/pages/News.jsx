        ...
        <Container className='news-container' fluid="md">
            <Row className='news-row'>
                ...
                <Col className='share-col'>
                    ...
                    <h2>Resources</h2>
                    <div className='books'>
                        <a href="https://shorturl.at/rszI5" target="_blank" rel="noopener noreferrer"> <img src="./src/assets/pitbullBook1.jpg" alt="" /></a>
                        <a href="https://shorturl.at/djnxU" target="_blank" rel="noopener noreferrer"> <img src="./src/assets/pitbullBook2.jpg" alt="" /></a>
                    </div>
                </Col>
            </Row>
        </Container>
