        ...
        <Container className='hero'>
            <Col>
              ...
              <Container className='background-container1'>
                ...
                <img id='childpic'src='./src/assets/child.jpg' alt='dog and child' ></img>              
                </Container>
              <img src='./src/assets/hero2.jpg' alt='Hero2' id='hero2' />
              <Container className='background-container2'></Container>
            </Col>
            ...
            <img src='./src/assets/walk.jpg' alt='Hero2' id='walk' />
            </Container>
